...
class ActionExecutor:
    ...
    def execute(self,action:Action)->bool:
        ...
        #单步重试机制(终态不重试)
        retries=0 if action.is_terminal() else self.cfg.action_retry
    ...
    def _click(self,a:Action)->None:
        if a.dom_selector:
            try:
                self._dom_click(a.dom_selector)
                return
            except Exception as e:
    ...
    def _goto(self,a:Action)->None:
        ...
        self.page.goto(a.url,wait_until="domcontentloaded",timeout=30_000)
    ...
    def _dom_click(self,selector:str)->None:
        ...
        locator.scroll_into_view_if_needed(timeout=3_000) #自动滑动到视野位置
    ...
    def _coord_click(self,x:int,y:int)->None:
        ...
        try:
            ...
            raise ActionExecutionError(f"坐标换算失败: {e}") from e
